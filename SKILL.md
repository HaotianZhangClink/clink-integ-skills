...
- require webhook handlers to verify the signature over the unmodified raw body before parsing or normalizing it, reject malformed payloads and unknown event types with non-2xx responses, and deduplicate retries by `event.id`
