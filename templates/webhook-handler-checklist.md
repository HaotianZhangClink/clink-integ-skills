...
- Treat default `clink webhook fixture`/`simulate` output as local canonical replay only; explicit `--fixture-profile legacy` is deprecated compatibility testing, and neither path proves real Clink sandbox Merchant Webhook UAT
