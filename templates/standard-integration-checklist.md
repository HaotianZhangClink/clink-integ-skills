...
- Configure `CLINK_SECRET_KEY` through either optional Playwright + local `clink login` + `clink dashboard apikey ensure-secret --save --json`, or a browserless manual Secret Key copied from `Merchant Dashboard > Developers > API Keys`
